...
export default function Footer() {
  return (
    <footer className="bg-charcoal-900 text-white pt-20 pb-10 font-medium">
      <Container>
        <div className="grid grid-cols-4 md:grid-cols-1 gap-12 mb-14">
        ...
        <div className="border-t border-charcoal-800 pt-8 flex flex-row md:flex-col justify-between items-center gap-4 text-sm text-charcoal-400">
          <p>© 2026 Lumière. Все права защищены.</p>
          <p>Лицензия на медицинскую деятельность № ЛО-77-01-019823</p>
          <a href="https://icher.pro" className="animate-color-flow">
            Разработчик
          </a>
        </div>
      </Container>
